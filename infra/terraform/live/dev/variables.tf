...
variable "secret_recovery_window_days" {
  description = "Secrets Manager soft-delete window for the app secret. 0 so a destroy/recreate cycle can reuse the name immediately. Deletion is irrecoverable at 0."
  type        = number
  default     = 0
}
